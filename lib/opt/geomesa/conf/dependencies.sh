...
accumulo_install_version=${ACCUMULO_VERSION}
hadoop_install_version=${HADOOP_VERSION}
zookeeper_install_version=${ZOOKEEPER_VERSION}
thrift_install_version="0.12.0"
